...
const UpdateCrud: React.FC<LogOutProps> = ({ userId, userProfile, refetchProfile, setEmailError, setIsEditing, setValidationError, setToggleUpdate }) => {
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`http://127.0.0.1:5000/user-management/users/${userId}`, trimmedUserProfile, {
        headers: {
