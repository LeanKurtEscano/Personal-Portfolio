        ...
        <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-10 md:px-10">
          ...
          >
            ...
            <p className="mb-6 text-white">
              I am a sophomore student at Laguna University, pursuing a BS in Information Technology with a focus on
              System Development.
            </p>
            ...
            <div className="flex justify-center mt-5 space-x-5 pr-10">
              <a href="https://x.com/Escano_Lean" target="_blank" rel="noopener noreferrer"
                ...
                </svg></a><a href="https://github.com/LeanKurtEscano" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.linkedin.com/in/leankurtescano/" target="_blank" rel="noopener noreferrer"
          ...
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <img src={puge} alt="Lean Kurt Escano" className="md:size-80 size-72 rounded-full" />
          </motion.div>
        </div>
      </div>
    </section>
